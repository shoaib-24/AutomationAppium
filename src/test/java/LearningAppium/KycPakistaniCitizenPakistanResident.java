...
public class KycPakistaniCitizenPakistanResident extends BaseTest {
...
//		driver.findElement(By.id("com.transsion.camera:id/shutter_panel_layout_root")).click();
		...
		driver.findElement(By.xpath("(//android.view.ViewGroup[@content-desc=\"Pakistani only\"])[1]")).click();
				
		// Residence
		driver.findElement(AppiumBy.accessibilityId("Country of Residence")).click();
		driver.findElement(By.xpath("(//android.view.ViewGroup[@content-desc=\"Pakistan\"])[1]")).click();
