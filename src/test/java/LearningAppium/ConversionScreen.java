...
public class ConversionScreen extends BaseTest {
	...
	public void ConversionTest() throws MalformedURLException , InterruptedException {
		...
		driver.findElement(AppiumBy.accessibilityId("Convert Rs. 4,996")).click();
		driver.findElement(By.xpath("(//android.view.ViewGroup[@content-desc=\"Convert Now\"])[2]")).click();
...
//		Thread.sleep(2000);
		...
		driver.findElement(By.xpath("//android.view.ViewGroup[@content-desc=\"Convert_Radio\"]/android.widget.ImageView")).click();
		Thread.sleep(1000);
