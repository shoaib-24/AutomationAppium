...
public class InvestmentHighRiskHavingNoKyc extends BaseTest{
...
//		driver.findElement(AppiumBy.androidUIAutomator("new UiScrollable(new UiSelector().scrollable(true).instance(0)).scrollIntoView(new UiSelector().text(\"Alfalah GHP Cash Fund\"));"));
		...
		driver.findElement(AppiumBy.accessibilityId("AKD Opportunity Fund, Conventional, High Risk, Return P.A, 3.74 %, NAV, 92.1543")).click();  	// testing
